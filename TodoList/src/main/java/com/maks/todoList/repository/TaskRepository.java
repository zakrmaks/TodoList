...
public interface TaskRepository extends JpaRepository<Task, Long> {
    ...
    Page<Task> findByParams(@Param("title") String title, @Param("completed") Integer completed, @Param("priorityId") Long priorityId, @Param("categoryId") Long categoryId, PageRequest pageRequest);
